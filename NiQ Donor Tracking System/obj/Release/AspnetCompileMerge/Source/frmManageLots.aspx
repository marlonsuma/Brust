...
<body>
    <form id="frmManageLots" runat="server">
        ...
        <asp:TextBox ID="txtTotalCases" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="3" Style="z-index: 2; left: 45px; position: absolute; top: 277px; width: 141px; bottom: 358px;" TabIndex="3" Enabled="False"></asp:TextBox>
        ...
        <asp:TextBox ID="txtSamplePouches" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="2" Style="z-index: 6; left: 45px; position: absolute; top: 385px; width: 141px; bottom: 250px;" TabIndex="5" Enabled="False"></asp:TextBox>
        ...
        <asp:TextBox ID="txtCasesRemaining" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="3" Style="z-index: 2; left: 45px; position: absolute; top: 329px; width: 141px; bottom: 306px;" TabIndex="4" Enabled="False"></asp:TextBox>
        ...
        <asp:TextBox ID="lotDate" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="255" Style="z-index: 2; left: 45px; position: absolute; top: 438px; width: 141px; bottom: 170px;" TabIndex="4" Enabled="False"></asp:TextBox>
