...
<body>
    <form id="frmManageCases" runat="server">
        ...
        <asp:TextBox ID="txtCaseID" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="9" Style="z-index: 2; left: 45px; position: absolute; top: 216px; width: 299px; bottom: 419px;" TabIndex="1"></asp:TextBox>
        ...
        <asp:TextBox ID="txtPONumber" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="50" Style="z-index: 2; left: 45px; position: absolute; top: 274px; width: 186px; bottom: 361px;" TabIndex="3" Enabled="False"></asp:TextBox>
        ...
        <asp:TextBox ID="txtCaseQuantity" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="3" Style="z-index: 2; left: 45px; position: absolute; top: 451px; width: 186px; bottom: 184px;" TabIndex="6" Enabled="False"></asp:TextBox>
    </form>
</body>
</html>
