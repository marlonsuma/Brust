<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreateDNAKit.aspx.cs" Inherits="NiQ_Donor_Tracking_System.frmCreateDNAKit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Ni-Q Donor Tracking System - Create Lab Kit</title>
</head>
<body>
    <form id="frmCreateDNAKit" runat="server">    
        ...
        <asp:Label ID="lblSubTitle" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="Arial" Font-Size="16pt" Style="z-index: 101; left: 45px; position: absolute; 
            top: 143px" Text="Create Lab Kit" Width="334px"></asp:Label>
        <asp:Image ID="imgLogo" runat="server" ImageUrl="~/images/Ni-Q Logo.png" Style="z-index: 108;
            left: 22px; position: absolute; top: 4px" />
        <asp:Label ID="lblMilkCollectionKitID" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10pt" Style="z-index: 1; left: 45px; position: absolute; top: 196px; width: 235px;" Text="Milk Collection Kit ID:"></asp:Label>
        <asp:TextBox ID="txtMilkKitID" runat="server" Font-Names="Arial" Font-Size="10pt" MaxLength="9" Style="z-index: 2; left: 45px; position: absolute; top: 216px; width: 186px; bottom: 419px;" TabIndex="1"></asp:TextBox>
        ...
        <asp:Label ID="lblMessage" runat="server" Font-Bold="False" Font-Italic="False" Font-Names="Arial" Font-Size="10pt" ForeColor="Red" Height="110px" Style="z-index: 101; left: 45px;
            position: absolute; top: 428px; width: 673px;"></asp:Label>
        ...
        <asp:Button ID="btnCreate" runat="server" Font-Names="Arial" Font-Size="10pt" OnClick="btnCreate_Click" Style="z-index: 106; left: 210px; position: absolute; top: 370px; width: 112px; height: 26px;" Text="Create" UseSubmitBehavior="False" TabIndex="4" />
        ...
        <asp:Button ID="btnNext" runat="server" Font-Names="Arial" Font-Size="10pt" OnClick="btnNext_Click" Style="z-index: 106; left: 354px; position: absolute; top: 370px; width: 112px; right: 1046px;" Text="Next Kit" UseSubmitBehavior="False" TabIndex="4" Visible="False" />
        ...
        <asp:Label ID="lblDonorIDTitle" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10pt" Style="z-index: 1; left: 353px; position: absolute; top: 231px; width: 81px;" Text="Donor ID:" Visible="False"></asp:Label>
        <asp:Label ID="lblDonorID" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="10pt" Style="z-index: 1; left: 443px; position: absolute; top: 231px; width: 284px;" Text="ndn01234567890" ForeColor="#3399FF" Visible="False"></asp:Label>
    </form>
</body>
</html>
